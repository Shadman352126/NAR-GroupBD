        ...
        <div className="container px-6 py-12 mx-auto">
          <div>
            ...
            <p className="mt-3 text-gray-500">
              We would adore hearing from you. To contact us, please fill out
            ...
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
              <div>
                ...
                <p className="mt-2 text-sm text-gray-500 ">
                  We have a helpful team here.
                </p>

                <p className="mt-2">
                  <a
                    href="mailto:nareng.solu@nar-groupbd.com"
              ...
              <div>
                ...
                <h2 className="mt-4 text-base font-medium  ">Website</h2>
                <p className="mt-2">
                  <a
                    href="www.narengineeringsolution.com"
                    className="text-sm text-blue-500 "
                  >
                    www.narengineeringsolution.com
                  </a>
                </p>
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-blue-500 ">
                  <a href="tel:+8801712711823">+8801712711823</a>
                </p>
              </div>
            </div>
